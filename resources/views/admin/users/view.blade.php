        ...
        <div class="col-md-6">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label class="control-label">Grant Permission</label>
                        <div class="ptero-permission-panel">
                            @if($isSuperAdmin)
                                <div class="ptero-permission-warning">
                                    <strong>Super Admin (ID 1)</strong>
                                    <span>This account always has full access.</span>
                                </div>
                            @endif
                            ...
                            <label class="ptero-switch inline">
                                <input
                                    ...
                                    name="root_admin"
                                    value="1"
                                    {{ $user->root_admin ? 'checked' : '' }}
                                    {{ $isSuperAdmin ? 'disabled' : '' }}
                                />
                                <span class="ptero-switch-slider"></span>
                                <span class="ptero-switch-label">Grant Admin Access</span>
                            </label>
                            <p class="text-muted small">Admins are restricted by the global permission manager in Settings. Admin ID 1 is never restricted.</p>
                        </div>
                    </div>
                </div>
            </div>
