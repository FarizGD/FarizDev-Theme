...
class SftpAuthenticationController extends Controller
{
    ...
    public function __construct(
        ...
        protected AdminFileBlockingService $fileBlocking,
    )
    {
    }
    ...
    {
        if ($this->fileBlocking->shouldEnforce($user)) {
            throw new HttpForbiddenException('SFTP access is disabled by admin file blocking policy.');
        }
